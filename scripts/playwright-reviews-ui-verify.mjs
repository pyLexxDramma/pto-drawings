...
// --- полоса этапов ---
// Числа в полосе этапов подписаны словами («листов 5 из 5», «7 · разобрано 0»),
// а завершённый этап дописывает галочку — всё это входит в имя кнопки.
const COUNT = String.raw`(листов \d+ из \d+|\d+ · разобрано \d+|ещё нет|нет файлов|режем на листы)( ✓)?`;
