...
const BLOCKS: Block[] = [
  ...
  {
    kind: "do",
    text: "Кликнуть по ссылке на лист в графе «Где в ПД» — откроется этот лист, цитата будет в расшифровке справа. Жёлтая «На предыдущую страницу» вернёт в таблицу.",
  },
  ...
  {
    kind: "do",
    text: "Кнопка «Скачать таблицу Excel» справа сверху. Открыть файл в Excel на месте.",
  },
  {
    kind: "p",
