 ...
 * с size_pt/text_len/reasons. Дословный текст листа остаётся раскрытым.
 */
const SERVICE_SECTION =
  /(состав\s+лист|геометри|карта\s+лист|описание\s+лист|описание\s+чертеж|информаци\S*\s+о\s+лист|по\s+изображени|якор)/i;
