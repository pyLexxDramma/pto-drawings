    ...
    <div className="space-y-3 text-[11px] leading-relaxed text-muted">
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            Справа всегда текст текущего листа. «‹» / «›» сворачивают панели.
          </li>
        </ul>
      </section>
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          <li>
            Фильтры в шапке — как в Excel. «Скачать таблицу Excel» качает то, что видно.
            Без важности и разбора у всех строк файл не выгрузится.
            Стрелка на колонке — только фильтр, статусы она не меняет.
            «Сбросить разбор» вернёт всем «Не разобрано».
          </li>
          <li>
            «Мои замечания из Excel» — ваш список в таблицу. Если в файле нет листа,
            колонка «Где в ПД» пустая.
          </li>
          <li>
            «Проставить, где в ПД» загорается после такого файла: конвейер ищет
            строки в расшифровке и пишет раздел, лист и цитату. На чертёж сама
            не ведёт.
          </li>
          <li>
            Клик по «Где в ПД» открывает лист здесь. <Kbd>Ctrl</Kbd>+клик (Mac{" "}
            <Kbd>⌘</Kbd>) или средняя кнопка — новая вкладка.
          </li>
          <li>
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            верхней строке. «Назад» из поиска возвращает туда, откуда открыли.
          </li>
        </ul>
      </section>
