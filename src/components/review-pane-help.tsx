    ...
    <div className="space-y-3 text-[11px] leading-relaxed text-muted">
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            строка уйдёт из таблицы, и наоборот.
          </li>
          <li>
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            «Проставить, где в ПД» загорается после такого файла: конвейер ищет
            формулировку в расшифровке и пишет раздел, лист и цитату. На чертёж
            сама не ведёт.
          </li>
          <li>
          ...
          <li>
            ...
            страницу»: этот лист → таблица → чертёж, с которого зашли в
            таблицу → список файлов проекта. Esc на листе — то же. Синяя
            «К проектам» слева в таблице — главная со списком проектов.
            Несколько мест одного расхождения — строки через ↔; с трёх —
            «ещё N мест».{" "}
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          <li>
            ...
            эта инструкция, выход.
          </li>
          <li>
            Шапка есть на каждой странице. Синяя «К проектам» (в шапке и
            слева в таблице замечаний) — главная со списком проектов слева.
            Жёлтая «На предыдущую страницу» — строго назад по шагам: таблица
            замечаний возвращает к чертежу, чертёж — к файлам проекта. Из
            поиска сначала закрывает поиск. Зелёная «Новый проект» — создать
            объект. Этапы «Расшифровка» / «Таблица замечаний» — в той же
            строке.
          </li>
        </ul>
      </section>
