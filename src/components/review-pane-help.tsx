      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            сначала закрывает поиск. Зелёная «Новый проект» — создать объект.
            На заставке «Открыть проект» — последний проект и его первый файл
            (если проектов нет — форма слева). Этапы «Расшифровка» /
