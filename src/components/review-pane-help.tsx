      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            текущее, синие — остальные на этой странице, оранжевая внутри
            зелёной — спорное значение из цитаты. Легенда цветов видна на листе
            рядом с «найдено: N». Разбор строки
