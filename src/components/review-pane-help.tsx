  ...
  return (
    <div className="space-y-3 text-[11px] leading-relaxed text-muted">
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          <li>
            Фильтры в шапке — как в Excel. «↓ XLSX» качает то, что видно.
          ...
          <li>
            «Загрузить Excel» — ваши замечания списком. Если в файле нет листа,
            колонка «Где в ПД» пустая.
          </li>
          <li>
            «Проставить, где в ПД» загорается после такого Excel: конвейер ищет
