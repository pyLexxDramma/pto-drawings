      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            кнопка «›» в правом конце строки над расшифровкой оставляет один
            чертёж.
          </li>
          <li>
            Слева в той же строке — жёлтая «← Лист N»: возврат к листу, с
            которого перешли на это замечание. Если переходов по листам не
            было, она ведёт на предыдущую страницу — в таблицу или к файлам.
          </li>
        </ul>
      </section>
      <section>
