      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            Если модель ошиблась или листала картинку — в той же строке знак
            «Ошибки модели». Клик открывает вкладку: откуда текст, что
            сравнить, чего нет в таблице и как поправить.
          </li>
          <li>
