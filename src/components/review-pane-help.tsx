      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            назад в ту же строку. В шапке «К чертежам» — ко всем файлам
            проекта. Несколько мест одного расхождения — строки через ↔; с
            трёх — «ещё N мест». <Kbd>Ctrl</Kbd>+клик (Mac <Kbd>⌘</Kbd>) или
