    ...
    <div className="space-y-3 text-[11px] leading-relaxed text-muted">
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            таблицу → список файлов проекта. Esc на листе — то же. Отдельной
            кнопки слева нет. Несколько мест одного расхождения — строки
            через ↔; с трёх — «ещё N мест».{" "}
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            Шапка есть на каждой странице. Синяя «К проектам» — главная со
            списком проектов слева. Жёлтая «На предыдущую страницу» — строго
            назад по шагам: таблица замечаний возвращает к чертежу, чертёж —
            к файлам проекта. Из поиска сначала закрывает поиск. Зелёная
            «Новый проект» — создать объект. Этапы «Расшифровка» /
            «Таблица замечаний» — в той же строке.
          </li>
        </ul>
      </section>
