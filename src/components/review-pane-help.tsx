    ...
    <div className="space-y-3 text-[11px] leading-relaxed text-muted">
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            Клик по «Где в ПД» открывает лист здесь. «К таблице замечаний» —
            на страницу, которую смотрели до этого листа. В шапке «К проектам» —
            ко всем файлам проекта. Несколько мест одного расхождения — строки
            через ↔; с трёх — «ещё N мест». <Kbd>Ctrl</Kbd>+клик (Mac{" "}
