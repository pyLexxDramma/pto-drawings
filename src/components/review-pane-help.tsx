      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            вправо — все колонки едут вместе. «‹» / «›» сворачивают панели, а
            «Скрыть текст · только чертёж» в правом конце строки над
            расшифровкой оставляет на экране один чертёж.
          </li>
          <li>
            Слева в той же строке — жёлтая кнопка возврата, по шагам: «← К
            замечаниям листа» снимает выбранное замечание и подсветку (список
            замечаний снова свёрнут, открывается кликом), «← Лист N» уводит на
            лист, с которого перешли, и только потом «← Назад» — на предыдущую
            страницу: таблицу замечаний или файлы проекта.
          </li>
        </ul>
      </section>
      <section>
