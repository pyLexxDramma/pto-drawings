      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            Зелёная точка — текст листа готов, серая — ещё считается, пустая
            с обводкой — лист готов, но вы его не открывали. Тип листа
            («чертёж», «таблица») появляется под миниатюрой при наведении;
            что значит точка — в подсказке на ней.
          </li>
          <li>
