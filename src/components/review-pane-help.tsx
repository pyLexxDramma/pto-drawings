    ...
    <div className="space-y-3 text-[11px] leading-relaxed text-muted">
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            Клик по «Где в ПД» открывает лист здесь. Жёлтая кнопка в шапке
            «На предыдущую страницу» — туда, откуда открыли этот лист
            (Esc делает то же). Отдельной кнопки слева нет. Несколько мест
            одного расхождения — строки через ↔; с трёх — «ещё N мест».{" "}
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            списком проектов слева. Жёлтая «На предыдущую страницу» — туда,
            откуда открыли этот экран (из поиска сначала закрывает поиск).
            Зелёная «Новый проект» — создать объект. Этапы «Расшифровка» /
