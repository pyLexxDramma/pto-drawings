      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            Если модель ошиблась или листала картинку — в той же строке
            маленькая кошка с числом. Клик открывает вкладку сверки: откуда
            текст, что сравнить, чего нет в таблице и как поправить.
          </li>
          <li>
